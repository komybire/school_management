...
background-image: url('images/photo-1432821596592-e2c18b78144f.jfif');
}
.loginform{
	text-align: center; 
margin: 10px 100px 10px ; 
...
text-align: center;
margin: 10px 100px 10px ; 
 background-image: url('images/contact%20image.jpg');"
...
<body>
    ...
    <nav style="padding:20px;margin:2px; background-color:pink;" class="navbar navbar-expand-lg">
      ...
      <div class="container-fluid">
        ...
        <a class="nav-link" href="about school.php">About school</a>
