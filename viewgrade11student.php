...
<body>
<h1>Students Informations  For Grade 11A And Grade 11B</h1>
</body>
</html>
<?php
...
// Select data from the "Students" table for grade 11
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Output students assigned to class 11A
        ...
        // Output students assigned to class 11B
