            ...
            if ($conn->query($insertStudentSql) === TRUE) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    if ($subjectCount > 0) {
                        ...
                        // Update average and rank in studentinformation table
                        ...
                        if ($conn->query($updateSql) === TRUE) {
                            echo "Average score and rank stored in the database.";
                        } else {


                        echo "Error storing average score and rank: " . $conn->error;
                        }
                    } else {
                ...
                echo "Error storing student information: " . $conn->error;
            }
        } else {
            echo "Student information already exists in the database.";
        }
    } else {
        echo "First name and middle name not provided.";
    }
}
